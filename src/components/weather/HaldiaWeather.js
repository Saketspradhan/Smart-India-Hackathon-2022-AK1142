...
const HaldiaWeather = () => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?lat=22.0447&lon=88.0888&units=metric&appid=5e6325fc7fcf751777a50f7292ca5b4b`;
  useEffect(() => {
