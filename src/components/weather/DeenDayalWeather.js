...
const DeenDayalWeather = () => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?lat=23.002721&lon=70.218651&units=metric&appid=5e6325fc7fcf751777a50f7292ca5b4b`;
  useEffect(() => {
...
export default DeenDayalWeather;
