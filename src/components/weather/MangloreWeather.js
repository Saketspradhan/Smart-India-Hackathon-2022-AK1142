...
const MangloreWeather = () => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?lat=12.927278&lon=74.812275&units=metric&appid=5e6325fc7fcf751777a50f7292ca5b4b`;
  useEffect(() => {
...
export default MangloreWeather;
