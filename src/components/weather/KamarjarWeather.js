...
const KamarjarWeather = () => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?lat=13.252851&lon=80.326744&units=metric&appid=5e6325fc7fcf751777a50f7292ca5b4b`;
  useEffect(() => {
...
export default KamarjarWeather;
