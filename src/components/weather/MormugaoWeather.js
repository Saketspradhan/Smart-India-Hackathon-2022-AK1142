...
const MormugaoWeather = () => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?lat=15.411207&lon=73.799978&units=metric&appid=5e6325fc7fcf751777a50f7292ca5b4b`;
  useEffect(() => {
...
export default MormugaoWeather;
