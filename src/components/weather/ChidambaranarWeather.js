...
const ChidambaranarWeather = () => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?lat=8.473&lon=78.1215&units=metric&appid=5e6325fc7fcf751777a50f7292ca5b4b`;
  useEffect(() => {
...
export default ChidambaranarWeather;
