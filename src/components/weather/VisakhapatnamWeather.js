...
const VisakhapatnamWeather = () => {
  ...
  const url = `https://api.openweathermap.org/data/2.5/weather?lat=17.695955&lon=83.2873&units=metric&appid=5e6325fc7fcf751777a50f7292ca5b4b`;
  useEffect(() => {
...
export default VisakhapatnamWeather;
